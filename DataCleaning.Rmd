...
write(index_train,file="C:\\Users\\NMLJ\\Desktop\\cycle3cvd-team8\\data\\index_train.txt")

index_test <- c(test_names)
write(index_test,file="C:\\Users\\NMLJ\\Desktop\\cycle3cvd-team8\\data\\index_test.txt")
...
```{r}
#For Training Set
breed_name <- rep(NA, length(img_train_dir))
for(i in 1:length(dir_names)){
  tt <- unlist(strsplit(img_train_dir[i], "_"))
  tt <- tt[-length(tt)]
...
write(index_train, "C:\\Users\\NMLJ\\Desktop\\cycle3cvd-team8\\data\\breed_index_train.txt")

#For Testing Set
breed_name <- rep(NA, length(test_names))
for(i in 1:length(test_names)){
  tt <- unlist(strsplit(img_test_dir[i], "_"))
  tt <- tt[-length(tt)]
  breed_name[i] = paste(tt, collapse="_", sep="")
}
cat_breed <- c("Abyssinian", "Bengal", "Birman", "Bombay", "British_Shorthair", "Egyptian_Mau", "Maine_Coon", "Persian", "Ragdoll", "Russian_Blue", "Siamese", "Sphynx")
...
write(index_test, "C:\\Users\\NMLJ\\Desktop\\cycle3cvd-team8\\data\\breed_index_test.txt")
