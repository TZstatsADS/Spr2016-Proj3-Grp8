...
###MARS
A MARS model, or multivariate adaptive regression splines, is a non-parametric regression tehcnique that automatically models nonlinearities and interactions between variables. It is a nonlinear statistical piecewise model.
